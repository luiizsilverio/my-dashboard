...
Desenvolvido durante o curso [React e TypeScript: desenvolvendo um Dashboard](https://www.udemy.com/course/react-e-typescript/), do professor _Rodrigo Gonçalves Santana_. <br />
A aplicação não trabalha com banco de dados nem login social. Seu propósito é a exibição de gráficos com animações, responsividade e temas dark e light.<br />
